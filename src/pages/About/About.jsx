      ...
      <div className='container'>
        ...
        <div className='about-content grid'>
          ...
          <div className='about-text'>
            ...
            <p className='fs-17'>At BookFinder, we make discovering books simple and enjoyable. Our platform is designed for readers who want quick access to the essentials—book cover, title, and author—so you can browse and find your next read without distractions.</p>
